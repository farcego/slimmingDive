##' NewFinalFilter
##'
##' Function to filter  Arce et al. criteria. It should be reimplemented in order to not lost the rejected dives (ie, generating a column logical, TRUE if accepted, FALSE if rejected)
