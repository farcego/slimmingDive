...
##' iterations.  There is a version that can paralelize the chains and
...
##'
##' Requires an object generated by the local function 'Kalman'. If the object is loaded form a previously saved session, the model will need to be recompiled.
##' @title updateKalman
